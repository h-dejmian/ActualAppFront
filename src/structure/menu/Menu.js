...
function Menu(props) {
    ...
    return (
        <div id="menu">
            ...
            <MenuElement name="My expenses" className="fa-solid fa-dollar-sign" id="3" setSelectedContent={props.setSelectedContent} />
            <MenuElement name="Statistics" className="fa-solid fa-chart-simple" id="4" setSelectedContent={props.setSelectedContent} />
            <MenuElement name="About" className="fa-solid fa-question" id="5" setSelectedContent={props.setSelectedContent} />
